...
func (p *processorService) ProcessAnalysis(ctx context.Context) (*model.Analysis, error) {
	...
	for actual < 5000 {
		...
		if err := p.queryDigitFrequencies(ctx, date, repetitionDigit); err != nil {
			return nil, fmt.Errorf("digit frequency query failed: %w", err)
		}

		if err := p.queryTwoDigitFrequencies(ctx, date, repetitionTwoDigit); err != nil {
			return nil, fmt.Errorf("two digit frequency query failed: %w", err)
		}

		if err := p.queryThreeDigitFrequencies(ctx, date, repetitionThreeDigit); err != nil {
			return nil, fmt.Errorf("three digit frequency query failed: %w", err)
		}

		if err := p.queryFourDigitFrequencies(ctx, date, repetitionFourDigit); err != nil {
			return nil, fmt.Errorf("four digit frequency query failed: %w", err)
		}
	...
	return &model.Analysis{
		...
		DaysAnalyzed:   frequenciesProcessed,
...
func (p *processorService) queryDigitFrequencies(ctx context.Context, fromDate time.Time, prob [][]float64) error {
...
func (p *processorService) queryTwoDigitFrequencies(ctx context.Context, fromDate time.Time, prob [][]float64) error {
...
func (p *processorService) queryThreeDigitFrequencies(ctx context.Context, fromDate time.Time, prob [][]float64) error {
...
func (p *processorService) queryFourDigitFrequencies(ctx context.Context, fromDate time.Time, prob []float64) error {
	for i := 0; i < 10000; i++ {
